...
public class EditBoardController {
	 ...
	 * @param loginMember : 로그인 한 회원 번호를 얻어오는 용도
	 ...
	 * @param loginMember		: 로그인 한 회원의 번호 이용
	 * @param ra
	...
	public String boardUpdate(@PathVariable("boardCode") int boardCode,
		...
		if(result > 0) {
			...
			message = "수정 실패";
			path = "update"; // 목표 : editBoard/1/1997/update?cp=1 (GET)
							 // 현재 : editBoard/1/1997/update?cp=1 (POST)
