 ...
 * 분산되어 있는 관심사/관점을 모듈화 시키는 기법
 * 
 * - 주요 비즈니스 로직과 관련이 없는 부가적인 기능을 추가할 때 유용
 * ex) 코드 중간 중간에 로그 찍을 때, 트랜잭션 처리하고 싶을 때 등등
 * 
 * 주요 어노테이션
...
public class TestAspect {
	...
	public void contollerEnd(JoinPoint jp) {
