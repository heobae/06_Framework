...
// 3) 좋아요 여부 준비
// likeCheck -> 현재 이 게시글의 likeCheck 값 (0인지 1인지, insert할지 delete할지)
// 1 -> D하기, 0 -> I 하기
...
if(updateBtn != null) { // 수정 버튼 존재 시
  ...
  updateBtn.addEventListener("click", () => {
    // get 방식
    // 현재 : /board/1/1997?cp=1
    // 목표 : /editBoard/1/1997/update?cp=1
...
if(deleteBtn != null) {
  deleteBtn.addEventListener("click", () => {
    ...
    // 현재 : board/1/1997?cp=1
    // 목표 : /editBoard/1/1997/delete?cp=1
