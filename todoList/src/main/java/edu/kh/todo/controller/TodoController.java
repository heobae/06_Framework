...
public class TodoController {
	...
	public String todoDetail(@RequestParam("todoNo") int todoNo,
		...
		Todo todo = service.todoDetail(todoNo);	// 제목, 내용, 작성일 등 모든 객체를 담아와야 해서 todo
		
		String path = null;
		
		// 조회결과가 있을 경우 detail.html 로 forward
		if(todo != null) {
	...
	@GetMapping("changeComplete") // 생략가능
	public String changeComplete(/*@ModelAttribute*/ Todo todo,
		...
		// 재요청 주소 : /todo/detail
		return "redirect:detail?todoNo=" + todo.getTodoNo(); // 상세페이지의 todoNo를 알아야 해서
	}
